...
#'       of the local ROPE (if the same folds were used for every algorithm). If the
...
#' @param dbcol Column number or name where the data set indicator is located, or 0 for no such column
...
#'          - spread: half (rounded up) of the tie count is added to each algorithm.
